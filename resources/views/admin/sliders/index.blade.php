            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-4 pull-right">
                        ...
                        <a href="{{ route('sliders.create') }}" class="btn btn-success"> {{ __('admin/app.add_new') }} <i class="fa fa-plus" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr id="row_{{$row->id}}">
                                ...
                                <td>
                                    <a href="{{route('sliders.edit',$row->id)}}" class="btn btn-primary btn-sm">
                                        <i class="bx bx-edit" aria-hidden="true"></i>
                                    </a>
                                    <button type="button" class="btn btn-danger waves-effect waves-light btn-sm" onclick="delete_alert({{$row->id}},'sliders')" ><i class="bx bx-trash"></i></button>
                                </td>
                            </tr>
                              @endforeach
