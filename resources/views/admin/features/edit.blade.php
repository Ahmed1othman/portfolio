...
@section('title')
    {{ trans('admin/features.Edit_feature') }}
@endsection
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('features.update', 'test') }}" method="post" autocomplete="off"
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <textarea class="form-control ckeditor1" rows="5"
                                              name="notes">  {{ $data->getTranslation('notes', 'en') }} </textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <textarea class="form-control ckeditor" rows="5"
                                              name="notes_ar">  {{ $data->getTranslation('notes', 'ar') }} </textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-9 mx-auto">
                                    ...
                                    <h6 class="mb-0 text-uppercase">{{ trans('admin/features.Attachments') }}
                                    </h6>
                                    <hr/>
                                    <div class="card">
                                        <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" name="active" value="1" type="checkbox"
                                               id="flexSwitchCheckChecked" {{ $data->active == 1 ? 'checked' : '' }}>
