                ...
                <div class="flex-col-s-c">
                    <div class="w-full pos-relative wrap-pic-w m-b-16">
                        ...
                        <div class="s-full ab-t-l flex-col-c-c hov-1 p-tb-30 p-rl-15">
                            <a href="{{ route('project.details',$row->id) }}" class="size-a-15 d-inline-flex flex-c-c bg-11 t1-s-2 text-uppercase cl-0 hov-btn2 trans-02 p-rl-10 hov-1-2">
                               {{ __('site/app.view_project') }}
                            </a>
                        </div>
                    </div>

                    <a href="{{ route('project.details',$row->id) }}" class="t1-m-1 cl-3 hov-link2 trans-02">
                        {{ $row->title }}
                    </a>
                </div>
            </div>
